        ...
        for (const pieceName of pieceNames) {
            ...
            switch (pieceName) {
                ...
                case 'prev': case 'next': case 'primitive': case 'sketchfab': case 'diagram': case 'text': case 'search-button': {
                    ...
                    iconEl.object3D.rotation.set(THREEMath.degToRad(-90), 0, 0);
                    pieceEl.setAttribute('material', 'color', inactiveColor);
                    break;
                }
                ...
                case 'search-panel': {
                    ...
                    searchTextEl.object3D.rotation.set(THREEMath.degToRad(-90), 0, 0);
...
function hsv2rgb(hsv) {
    var r, g, b, i, f, p, q, t;
    var h = THREEMath.clamp(hsv.h, 0, 1);
    var s = THREEMath.clamp(hsv.s, 0, 1);
    var v = hsv.v;
